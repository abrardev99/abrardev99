    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
      <div class="container d-flex justify-content-between">
        <a href="#" class="navbar-brand d-flex align-items-center">
          <svg id="b33613f3-47b2-4fb7-9d5b-ca5c70d6619d" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            width="30px" height="30px" viewBox="0 0 863 826.71426">
  ...
  <div class="container">
    <div class=" row">
      ...
      <div class="col-md-8 col-sm-12">
        <h1 class="text-success text-monospace">Hello,</h1>
        <h3 class="text-monospace">I'm Abrar</h3>
        <p class="text-monospace">I'm a web dev and maker.</p>
        <p class="text-monospace">I am a <span class="badge badge-success">full-stack PHP Laravel developer</span>. From
          a very early age I've been fascinated
          with
          computers, which led me to
          pursue a degree in <span class="badge badge-success">Computer Science</span>. Later, I fell in love with
          <span class="badge badge-success">web development</span> and never looked back.
          Currently I work full time as a <span class="badge badge-success">Laravel</span> freelance developer, serving
          businesses
          over the word.</p>
        <p class="text-monospace"><a href="#"><span class="badge badge-success">Recent Projects</span></a></p>
        <p class="text-monospace"><a href="#"><span class="badge badge-warning">See my Blog (Laravel Tip of the
              Day)</span></a></p>
        <div class="btn-group" role="group" aria-label="Basic example">
          <button data-toggle="tooltip" data-placement="top" title="Github" type="button"
            class="btn btn-secondary"><span class="fa fa-github"></span></button>
          <button data-toggle="tooltip" data-placement="top" title="Twitter" type="button"
            class="btn btn-secondary"><span class="fa fa-twitter"></span></button>
          <button data-toggle="tooltip" data-placement="top" title="Stackoverflow" type="button"
            class="btn btn-secondary"><span class="fa fa-stack-overflow"></span></button>
          <button data-toggle="tooltip" data-placement="top" title="Linkedin" type="button"
            class="btn btn-secondary"><span class="fa fa-linkedin"></span></button>
          <button data-toggle="tooltip" data-placement="top" title="My Resume" type="button"
            class="btn btn-secondary"><span class="fa fa-file"></span></button>
        </div>
